package com.nana.nana.domain.feature.assemblysync.apihelper

import com.nana.nana.domain.feature.assemblysync.OpenAssemblyResultCode.Ok.SUCCESS
import com.nana.nana.domain.feature.assemblysync.apihelper.OpenAssemblyAPICommonKey.CODE
import com.nana.nana.domain.feature.assemblysync.apihelper.OpenAssemblyAPICommonKey.HEAD
import com.nana.nana.domain.feature.assemblysync.apihelper.OpenAssemblyAPICommonKey.ITEMS
import com.nana.nana.domain.feature.assemblysync.apihelper.OpenAssemblyAPICommonKey.ITEM_COUNT
import com.nana.nana.domain.feature.assemblysync.apihelper.OpenAssemblyAPICommonKey.MESSAGE
...
suspend fun <R, T> OpenAssemblyBaseApiResponse<R>.handleOpenAssemblyApiResponse(
    onSuccess: suspend (itemTotalCount: Int, pagedItems: List<R>?) -> T,
    onError: suspend (errorResult: OpenAssemblyResult) -> T
): T {
